...
export const BriefcaseIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H5.998a2.25 2.25 0 01-2.25-2.25v-4.07a2.25 2.25 0 01.958-1.785 2.25 2.25 0 012.634-.465 2.25 2.25 0 011.706 2.25v.75a.75.75 0 001.5 0v-.75a.75.75 0 00-.75-.75h-.75a2.25 2.25 0 01-2.25-2.25V7.5a2.25 2.25 0 012.25-2.25h6.75a2.25 2.25 0 012.25 2.25v3.375c0 .621.504 1.125 1.125 1.125h.75c.621 0 1.125-.504 1.125-1.125V7.5a3.75 3.75 0 00-3.75-3.75H5.998a3.75 3.75 0 00-3.75 3.75v8.25a3.75 3.75 0 003.75 3.75h12.252a3.75 3.75 0 003.75-3.75v-4.07a.75.75 0 00-1.5 0z" />
  </svg>
);
...
export const TrophyIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 01-9-9.75V7.5a9.75 9.75 0 019-9.75h9a9.75 9.75 0 019 9.75v1.5a9.75 9.75 0 01-9 9.75z" />
    </svg>
);
...
export const SatelliteIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5V21A3.375 3.375 0 0110.125 17.625v-4.524m-3.375 4.524V10.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.043 10.5h5.914m-5.914 0a2.625 2.625 0 10-5.25 0 2.625 2.625 0 005.25 0zm5.914 0a2.625 2.625 0 105.25 0 2.625 2.625 0 00-5.25 0z" />
